...
We set out the conceptual framework that will allow us to unify the various ideas presented. First we clarify the difference between the probabilistic and the deterministic view of Neural nets, then we show how various notions of metrics defined on the ``output'' will in a sense give recognisable objects when pulled back either to the paremeter space, or the data space.

\begin{figure}[h!]
%  \checkparity This is an \pageparity\ page.%
  \caption{Probabilistic vs. Deterministic view of neural nets.
}
\input{tikz/prob-vs-det.tikz}
  \label{fig:probabilisticvsdeterministicview}
...
\newthought{In his later books},\cite{Sun2025} Tufte
